...
public class Banka {
	...
	public void BilgileriDisaridanDoldur(int hesap_no,String Hesap_tipi, String musteri_adi,double hesap_bakiye) { //farklı bir yol
	...
	private boolean ParaYatırKontrolOnay(String doviz_tipi) { //private oaln bir yapıya sadece o sınıf erişebilir
		boolean onay = false;
		if (doviz_tipi.equals(Hesap_tipi)) {
			onay = true;
		}
	...
	private void Islem_Yazdir(String mesaj, int hesap_no, String Hesap_tipi, String musteri_adi, double hesap_bakiye,
	...
	public void Hesap_Ozet() {
		...
		System.out.println("hesap bakiye bilgisi " + hesap_bakiye + " " + Hesap_tipi);
